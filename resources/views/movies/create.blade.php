<x-details-layout class="space-y-6 dark:bg-zinc-800 dark:text-white">
                ...
                <div>
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <textarea name="description" id="description" rows="3"
                            class="p-2  border block w-full max-w-lg border-gray-300 dark:border-zinc-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ old('description') }}</textarea>
                    </div>
                </div>
                <div>
