    ...
    <div class="mt-10">
        ...
        <ul class="mt-4 text-gray-400 text-xs space-y-3">
            <li class="flex space-y-3 space-x-3 ">
                <img src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:l-text,ie-MjAyNA%3D%3D,fs-29,co-FFFFFF,ly-612,lx-24,pa-8_0_0_0,l-end/et00323145-rdtfabgeax-portrait.jpg"
                    class="w-1/3 rounded-md" alt="">
                <div class="flex flex-col justify-between  ">
                    <div class="flex flex-col space-y-1">
                        <span class="text-gray-700 dark:text-white font-semibold">Dandnayak</span>
            ...
            <li class="flex space-x-3 ">
                <img src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:l-text,ie-NCwgT2N0IDIwMjQ%3D,fs-29,co-FFFFFF,ly-612,lx-24,pa-8_0_0_0,l-end/et00414429-kpbdmtbyhx-portrait.jpg"
                    class="object-cover w-1/3 rounded-md" alt="">
                <div class="flex flex-col justify-between  ">
                    <div class="flex flex-col space-y-1">
                        <span class="text-gray-700 dark:text-white font-semibold">Haathi Mere Saathi</span>
            ...
            <li class="flex space-x-3 ">
                <img src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:l-text,ie-MjAyNA%3D%3D,fs-29,co-FFFFFF,ly-612,lx-24,pa-8_0_0_0,l-end/et00406669-ahdawnfunl-portrait.jpg"
                    class="object-cover w-1/3 rounded-md" alt="">
                <div class="flex flex-col justify-between  ">
                    <div class="flex flex-col space-y-1">
                        <span class="text-gray-700 dark:text-white font-semibold">Aasara</span>
    ...
    <div class="mt-10">
        ...
        <ul class="mt-4 text-gray-400 text-xs space-y-3">
            ...
            <li class="flex space-x-3 ">
                ...
                <div class="flex flex-col justify-between  ">
                    <div class="flex flex-col space-y-1">
                        <span class="text-gray-700 dark:text-white font-semibold">The Silence of the
                            Lambs</span>
