<aside class=" w-1/6 py- pl-10  min-w-min  border-r border-gray-300  hidden md:block ">

    <div class=" font-bold text-lg flex items-center">
        <!-- <svg class="h-8 w-8 fill-accent-dark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
        ...
        <div class="tracking-wide text-sm">CG Chartbusters<span class="text-red-600">.</span>
        </div> -->
    ...
    <div class="mt-4 flex flex-col gap-y-4 text-gray-500 fill-gray-500 text-sm">
        ...
        <a class="flex items-center space-x-2 py-1  font-semibold  border-r-4 border-r-accent-dark pr-20 "
            href="#">
            <svg class="h-5 w-5 fill-accent-dark " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path
        ...
        <a class=" flex items-center space-x-2 py-1  group hover:border-r-4 hover:border-r-accent-dark hover:font-semibold "
            href="#">
            <svg class="h-5 w-5 group-hover:fill-accent-dark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g>
                    <path
