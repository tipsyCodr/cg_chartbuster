<div class="" x-show="isActive === 'albums'" style='display: none;' x-transition>
    <section>
        <div class="flex flex-col justify-between mt-4 bg-black/10 bg-blend-multiply rounded-3xl h-80 overflow-hidden bg-cover bg-center px-7 pt-4 pb-6 text-white"
            style="background-image: url('images/album.jpg');">
            ...
            <div class="bg-gradient-to-r from-black/30 to-transparent -mx-7 -mb-6 px-7 pb-6 pt-2">
                <span class="uppercase text-3xl font-semibold drop-shadow-lg ">New Album</span>
                ...
                <div class="mt-4 flex space-x-3 items-center">
                    <a href="#"
                        class="px-5 py-2.5 bg-red-600 hover:bg-red-700 rounded-lg text-xs inline-block">View</a>
    ...
    <section class="mt-9">
        <div class="flex items-center justify-between">
            <span class="font-semibold text-gray-700 text-base dark:text-white">Top Artists</span>
        ...
        <div class="mt-4 grid grid-cols-2  sm:grid-cols-4 gap-x-5 gap-y-5">
            <div class="relative rounded-xl overflow-hidden">
                <img src="https://upload.wikimedia.org/wikipedia/commons/7/79/Pawan_Singh_in_a_concert.jpg"
                ...
                <div
                    ...
                    <div class="self-center flex flex-col items-center space-y-2">
                        <span class="capitalize text-white font-medium drop-shadow-md">Pawan Singh</span>
            ...
            <div class="relative rounded-xl overflow-hidden ">
                <img src="https://media.newstracklive.com/uploads/entertainment-news/regional-cinema-news/May/21/big_thumb/khesari3_60a78f9322cd6.jpg"
                ...
                <div
                    ...
                    <div class="self-center flex flex-col items-center space-y-2">
                        <span class="capitalize text-white font-medium drop-shadow-md">Khesari Lal Yadav</span>
            ...
            <div class="relative rounded-xl overflow-hidden ">
                <img src="https://www.jagranimages.com/images/newimg/30052019/30_05_2019-manoj-tiwari_19268464_17510995.jpg"
                    class="object-cover h-full w-full -z-10" alt="">
                <div
                    class="absolute top-0 h-full w-full bg-gradient-to-t from-black/50 p-3 flex flex-col justify-between">
            ...
            <div class="relative rounded-xl overflow-hidden ">
                <img src="https://t1.gstatic.com/licensed-image?q=tbn:ANd9GcS6gAbo7Rz8DY6jc49f-HH2ZXkTkYGQzAmhPDaWqUOw4pV2NtsYUZZvJhdcP5EJLGVy"
                    class="object-cover h-full w-full -z-10" alt="">
                <div
                    class="absolute top-0 h-full w-full bg-gradient-to-t from-black/50 p-3 flex flex-col justify-between">
                    ...
                    <div class="self-center flex flex-col items-center space-y-2">
                        <span class="capitalize text-white font-medium drop-shadow-md">Malini Awasthi</span>
    ...
    <section class="mt-9">
        ...
        <div class="mt-4 grid grid-cols-2 gap-y-5 sm:grid-cols-3 gap-x-5 ">
            <div class="flex flex-col rounded-xl overflow-hidden aspect-square border dark:border-zinc-600">
                <img src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:l-text,ie-MjAyNA%3D%3D,fs-29,co-FFFFFF,ly-612,lx-24,pa-8_0_0_0,l-end/et00071338-wuryjtnsez-portrait.jpg"
                ...
                <div
                    ...
                    <span class="capitalize  font-medium truncate">Dil Hamaar</span>
            ...
            <div class="flex flex-col rounded-xl overflow-hidden aspect-square border dark:border-zinc-600">
                <img src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:l-text,ie-MjAyNA%3D%3D,fs-29,co-FFFFFF,ly-612,lx-24,pa-8_0_0_0,l-end/et00070967-qlvavmzvpt-portrait.jpg"
                    class=" h-4/5 object-cover w-full  " alt="">
                <div
                    class="w-full h-1/5 bg-white dark:bg-zinc-800 dark:text-white px-3 flex items-center justify-between border-t-2 border-t-red-600">
                    <span class="capitalize  font-medium truncate">Veer Yodha Mahabali</span>
                    <div class="flex space-x-2 items-center text-xs">
                        <svg class="w-8 h-5" xmlns="http://www.w3.org/2000/svg" width="64" height="32"
                            viewBox="0 0 64 32" version="1.1">
                            <g fill="#F5C518">
            ...
            <div class="flex flex-col rounded-xl overflow-hidden aspect-square border dark:border-zinc-600">
                <img src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:l-text,ie-MjAyNA%3D%3D,fs-29,co-FFFFFF,ly-612,lx-24,pa-8_0_0_0,l-end/et00074920-bmdmcjtfsp-portrait.jpg"
                    class=" h-4/5 object-cover w-full  " alt="">
                <div
                    class="w-full h-1/5 bg-white dark:bg-zinc-800 dark:text-white px-3 flex items-center justify-between border-t-2 border-t-red-600">
                    <span class="capitalize  font-medium truncate">Hamaar Mission Banaras</span>
                    <div class="flex space-x-2 items-center text-xs">
                        <svg class="w-8 h-5" xmlns="http://www.w3.org/2000/svg" width="64" height="32"
                            viewBox="0 0 64 32" version="1.1">
                            <g fill="#F5C518">
