<x-app-layout>
    @section('meta_title', 'Submit a Song — CG Chartbusters')
        ...
        <div class="max-w-5xl mx-auto px-4 space-y-8">
            <div>
                <h1 class="text-3xl font-extrabold text-white tracking-tight">Submit a <span
                        class="text-yellow-400">Song</span></h1>
            ...
            <form action="{{ route('submit.song.store') }}" method="POST" enctype="multipart/form-data"
                class="space-y-8">
                @csrf

                <x-admin.form-section title="Basic Information" description="Core song details"
                    ...
                    <x-admin.form-group label="Song Title" for="title" required :error="$errors->first('title')">
                        <x-admin.input type="text" name="title" id="title" required value="{{ old('title') }}"
                            placeholder="Enter song title" :error="$errors->has('title')"
                            class="bg-gray-850 border-gray-700 text-white" />
                    </x-admin.form-group>

                    <x-admin.form-group label="Album" for="album">
                        <x-admin.input type="text" name="album" id="album" value="{{ old('album') }}"
                            placeholder="Album name" class="bg-gray-850 border-gray-700 text-white" />
                    </x-admin.form-group>
                    ...
                    <x-admin.form-group label="Duration" for="duration">
                ...
                <x-admin.form-section title="Media Assets" description="Poster and video link"
                    class="bg-gray-900 border-gray-800 text-white">
                    ...
                    <div class="md:col-span-2">
                        <x-admin.form-group label="Video / Trailer URL" for="trailer_url">
                ...
                <x-admin.form-section title="Metadata" description="Genres, region, and artists"
                    class="bg-gray-900 border-gray-800 text-white">
                                ...
                                <template x-for="(entry, index) in artistEntries" :key="index">
                                    <div
                                        ...
                                        <div class="flex-1 w-full">
                                            <label
                                                class="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1.5 block">Artist</label>
                                        ...
                                        <div class="flex-1 w-full">
                                            <label
                                                class="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1.5 block">Role</label>
                                        ...
                                        <button type="button" @click="removeArtistEntry(index)"
                                            class="w-12 h-12 rounded-xl bg-rose-955/30 border border-rose-500/30 text-rose-400 flex items-center justify-center hover:bg-rose-600 hover:text-white transition-all shrink-0">
