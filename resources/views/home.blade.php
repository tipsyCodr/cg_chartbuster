                    ...
                    @foreach ($banner_images as $banner_image)
                        <div class="p-2 bg-gray-800 rounded-lg cursor-pointer swiper-slide max-w-[370px]">
                            <div class="flex items-end h-full gap-4">
                                <img class="object-cover w-24 h-32 rounded-lg"
                                    src="{{ asset('storage/' . ($banner_image['poster_image'] ?? 'storage/images/coming-soon.png')) }}"
                                    alt="Thumbnail">
                                <div class="flex flex-col justify-end flex-1">
                                    <h1 class="text-xs font-bold truncate" style='width:165px'>{{ $banner_image['title'] }}
                                    </h1>
                                    <div class="flex flex-row items-center text-gray-300 truncate" style='width:170px'>
                                        ...
                                        <div class="flex flex-col items-start justify-start">
                                            <p class="text-xs"> {{ $banner_image['cg_chartbusters_ratings'] ?? 1 }} /10
                                                Ratings</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <a href="{{ route('movie.show', $movie->slug) }}">
                        <div class="flex-shrink-0 mr-4 transition-all bg-gray-900 rounded-lg shadow-md last:mr-0 ">
                            <div class="relative min-w-48 max-w-48">
                                {{-- rating --}}
                                <span
                                    class="absolute z-50 mr-2 font-bold text-yellow-500 top-2 -left-5 text-shadow-md text-8xl text-stroke stroke-white">{{ $loop->index + 1 }}</span>
                                ...
                                <div class="px-4 py-4 bg-gray-900 rounded-b-lg h-30">
                                    <div class="">
                                        {{-- <span class="text-white"> <i class="text-yellow-500 fa-solid fa-star"></i>
                                            {{ $movie->cg_chartbusters_ratings }} / 10 </span> --}}
                        ...
                        <div class="flex-shrink-0 mr-4 transition-all bg-gray-900 rounded-lg shadow-md last:mr-0">
                            <div class="relative min-w-48 max-w-48">
                                ...
                                <div class="px-4 py-4 bg-gray-900 rounded-b-lg h-30">
                                    <div class="">
                                        {{-- <span class="text-white"> <i class="text-yellow-500 fa-solid fa-star"></i>
                                            {{ $song->cg_chartbusters_ratings ?? 'N/A' }} / 10 </span> --}}
                                        <div class="flex justify-start items-center gap-1 text-xs mb-4 text-gray-300">
                                            <img src="{{ asset('images/badge.png') }}" alt="CG Chartbusters Rating"
                                                class="w-4 h-4">
