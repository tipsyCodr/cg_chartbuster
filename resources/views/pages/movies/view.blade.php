        ...
        <div class="bg-gray-800 rounded-xl shadow-2xl overflow-hidden mb-8 grid lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 hero-section p-4">
                <div class="hero-media h-full w-full">
                    @if($movie->trailer_url && str_contains($movie->trailer_url, 'http'))
                        {!! $movie->trailer_url !!}
            ...
            <div class="lg:col-span-1 p-6 flex flex-col justify-between">
                <div>
                    ...
                    {{-- <div class="flex items-center gap-2 mb-3">
                        ...
                        <span class="text-gray-300">{{ $movie->cg_chartbusters_ratings }} / 10</span>
                    </div> --}}
                    ...
                    <div class="text-gray-300 mb-2"><strong>Genre:</strong>
                        {{ $movie->genres->pluck('name')->implode(', ') ?: 'N/A' }}</div>
                    @if(!empty($movie->duration) && !in_array($movie->duration, ['00:00', '00:00:00', '05:00', '00:05:00']))
                        <div class="text-gray-300 mb-2"><strong>Duration:</strong> {{ substr($movie->duration, 0, 5) }} Hrs
                        </div>
                    @endif
                    <div class="text-gray-300 mb-2"><strong>Language:</strong> {{ $movie->region?->name ?? 'N/A' }}
                    </div>
