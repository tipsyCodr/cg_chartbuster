    ...
    <section class="mt-8 min-h-[50vh]">
        ...
        <div class="mt-8 space-y-4">
            @foreach ($songs as $song)
                @php
                    $year = $song->release_date ? \Carbon\Carbon::parse($song->release_date)->format('Y') : 'N/A';
                    $cbfc = $song->cbfc ?: 'NA';
                    $genresText = $song->genres->pluck('name')->implode(', ') ?: 'Genres';
                    $votes = $song->reviews_count ?? 0;
                @endphp
                    ...
                    <div class="flex min-h-40">
                        ...
                        <div class="flex flex-1 flex-col justify-center gap-3 px-4 py-4 sm:px-5">
                            ...
                            <div class="flex items-center gap-2 text-sm sm:text-2xl/none">
                                ...
                                <span class="font-bold text-white">{{ $song->cg_chartbusters_ratings ?? 0 }}/10</span>
