            ...
            <div class="p-5 overflow-hidden bg-white shadow-xl sm:rounded-lg">
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full px-4 md:w-1/2">
                        ...
                        <p class="mb-5 text-gray-600">Budget: <span class="font-bold text-black">Rs.</span>{{ $tvshow->budget }}</p>
                        <p class="mb-5 text-gray-600">Box Office: <span class="font-bold text-black">Rs.</span>{{ $tvshow->box_office }}</p>
                    </div>
                    <div class="w-full px-4 md:w-1/2">
