...
@section('content')
    <div class="container px-3 py-6 mx-auto sm:px-4 sm:py-8 max-w-4xl">
        <div class="mb-6 flex items-center justify-between">
            <h1 class="text-2xl font-bold">Edit Hero Banner</h1>
                ...
                <div class="space-y-4">
                    <div class="mb-4">
                        ...
                        <img src="{{ asset('storage/' . $heroBanner->image_path) }}" 
                             class="w-full max-w-md h-auto object-cover rounded-lg shadow-md border border-gray-200" alt="Current Banner">
                    </div>

                    <div>
                        <label for="image" class="block mb-1.5 text-sm font-bold text-gray-700">Change Banner Image (Optional)</label>
                    ...
                    <div>
                        ...
                        <input type="url" name="link_url" id="link_url" value="{{ old('link_url', $heroBanner->link_url) }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $heroBanner->sort_order) }}"
                                class="mt-1 block w-full rounded-lg border-gray-300 text-base p-2.5 shadow-sm focus:border-accent focus:ring focus:ring-accent/20 transition-all">
                        </div>

                        <div class="flex items-center gap-2 pt-8">
                            <input type="checkbox" name="is_active" id="is_active" value="1" {{ $heroBanner->is_active ? 'checked' : '' }}
