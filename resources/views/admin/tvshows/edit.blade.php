                            ...
                            <div class="mb-4 ">
                                ...
                                <div>
                                    ...
                                    <textarea name="content_description_chh" id="content_description_chh" rows="3"
                                        class="mt-1 block w-full @error('content_description_chh') is-invalid @enderror rounded-md  border p-2 border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ $tvshows->content_description_chh }}</textarea>
