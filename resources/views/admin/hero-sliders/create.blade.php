...
@section('page-title', 'Create Premium Hero Slider')

@section('content')
    <div class="container px-3 py-6 mx-auto sm:px-4 sm:py-8 max-w-4xl">
        <div class="mb-6 flex items-center justify-between">
            <h1 class="text-2xl font-black text-gray-800">Create Premium Hero Slider</h1>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-10">
            <form action="{{ route('admin.hero-sliders.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="md:col-span-2">
                        <label for="image" class="block mb-2 text-xs font-black text-gray-400 uppercase tracking-widest">Background Poster Image</label>
                        ...
                        <p class="mt-2 text-[10px] text-gray-400 font-bold italic uppercase tracking-wider">High-quality landscape recommended. Max size: 5MB.</p>
                    </div>
