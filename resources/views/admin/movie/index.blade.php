...
<div class="container px-4 py-8 mx-auto">
    <div class="mb-8 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-black text-gray-800 tracking-tight uppercase">MOVIE MANAGEMENT</h1>
            <p class="text-xs text-gray-400 font-bold uppercase tracking-widest mt-1">Manage your movie catalog and featured content</p>
        </div>
        
        <div class="flex items-center gap-3">
             <div class="flex items-center gap-2 px-4 py-2 bg-blue-50 rounded-xl border border-blue-100">
                <span class="w-2 h-2 rounded-full bg-blue-500 animate-pulse"></span>
                <span class="text-[10px] font-black text-blue-600 uppercase tracking-widest">Live Catalog</span>
            </div>
        </div>
    </div>
