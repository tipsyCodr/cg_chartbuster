...
@section('content')
    <div x-data="{ showMovieModal: false }" class="container px-3 py-6 mx-auto sm:px-4 sm:py-8">
        ...
        <div x-show="showMovieModal" x-cloak
            class="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto px-2 py-4 outline-none focus:outline-none sm:px-4 sm:py-6">
            <div class="relative w-full max-w-5xl mx-auto my-auto shadow-2xl">
                <div x-show="showMovieModal" x-transition:enter="ease-out duration-300"
                    x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100"
                    x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 scale-100"
                    x-transition:leave-end="opacity-0 scale-95"
                    class="relative flex flex-col w-full bg-white border-0 rounded-2xl outline-none focus:outline-none z-60 max-h-[90vh]">

                    <!-- Modal Header -->
                    <div class="flex items-start justify-between p-5 border-b border-solid rounded-t border-blueGray-200">
                        <h3 class="text-2xl font-semibold">Add New Movie</h3>
                        <button @click="showMovieModal = false"
                            class="float-right p-1 ml-auto text-3xl font-semibold leading-none text-black bg-transparent border-0 outline-none opacity-100 focus:outline-none">
                    ...
                    <form action="{{ route('admin.movies.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label for="title" class="block mb-1.5 text-sm font-bold text-gray-700">Movie Title</label>
                                ...
                                <div>
                                    <label for="content_description_chh" class="block mb-1.5 text-sm font-bold text-gray-700">Plot (Chhattisgarhi)</label>
                                    <textarea name="content_description_chh" id="content_description_chh" rows="4"
                                        class="mt-1 block w-full rounded-lg border-gray-300 text-base p-2.5 shadow-sm focus:border-accent focus:ring focus:ring-accent/20 transition-all"></textarea>
                                </div>
                        ...
                        dateInput.value = dateInput.value + '-01-01';
                            ...
                            <div class="space-y-4">
                                ...
                                x-init="fetchData()">
                                    ...
                                    <div class="space-y-3">
                                        <template x-for="(entry, index) in artistEntries" :key="index">
                                            <div class="p-3 border border-gray-100 rounded-xl bg-gray-50/50 space-y-3">
                                                ...
                                                <button type="button" 
                                                        ...
                                                        class="w-full px-4 py-2 text-sm font-bold text-red-500 bg-red-50 rounded-lg hover:bg-red-100 transition-colors">
                                                    Remove Artist
                                                </button>
                                            </div>
                                        </template>
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-star-rating id="rating" class="block w-full" name="cg_chartbusters_ratings" required></x-star-rating>
                                </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        <label for="poster_image" class="block mb-1.5 text-sm font-bold text-gray-700">Poster (Portrait)</label>
                                    ...
                                    <div>
                                        <label for="poster_image_landscape" class="block mb-1.5 text-sm font-bold text-gray-700">Poster (Landscape)</label>
