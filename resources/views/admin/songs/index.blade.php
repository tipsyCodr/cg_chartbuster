                    ...
                    <form action="{{ route('admin.songs.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label for="content_description_chh" class="block mb-1.5 text-sm font-bold text-gray-700">Lyrics (Chhattisgarhi)</label>
                                    <textarea name="content_description_chh" id="content_description_chh" rows="4" placeholder="छत्तीसगढ़ी मं गीत के बोल एहाँ भरव…"
                                        class="mt-1 block w-full rounded-lg border-gray-300 text-base p-2.5 shadow-sm focus:border-accent focus:ring focus:ring-accent/20 transition-all"></textarea>
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label for="poster_image" class="block mb-1.5 text-sm font-bold text-gray-700">Poster Image</label>
