...
class MovieSubmitController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('submissions.movie.create', compact(
    ...
    public function store(Request $request)
    {
        ...
        MovieSubmission::create(array_merge($validated, [
            'user_id'      => auth()->id(),
            'status'       => 'pending',
            'genre_ids'    => $genreIds,
        ...
        return redirect()->route('submit.movie.create')
            ->with('success', 'Your movie submission has been received and is pending admin review. Thank you!');
    }
}
